...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27-Jan-2021 às 01:57
...
(1, 3, 9, 'Erick Rangel', 'eriel.rj@gmail.com', '$2y$10$1tOaujgz/RfImN.00SPFY.D53Jrbvnkiczk6DlX/Q66H1FNLU7VPC', '21044-630', 'Rio de Janeiro', 'Maré', 'Nice'),
...
(3, 6, NULL, 'Theodoro Otto Loetscher', 'thed@hotmail.com', '$2y$10$21.cFeSqBOFiCkJCMCbnT./RFTsVNn1YL0Bd3tAzBCkzQl330y9L2', '22070-012', 'Rio de Janeiro', 'Copacabana', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.'),
(4, 1, 1, 'Edith Loetscher', 'edith@hotmail.com', '$2y$10$HJlOcPUffaSs23S6fjTbV.0y1RaWrmU8gEeLm4obWVuVa.sHWMlym', '22020-002', 'Rio de Janeiro', 'Copacabana', 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.'),
(5, 1, 1, 'eda burckhardtt', 'eda@hotmail.com', '$2y$10$iEyEvtKuEsEtNCHlC0qJ3O5Xv7/iqwSbwqt1gohmMUtTiNOcRuDYm', '22060-970', 'Rio de Janeiro', 'Copacabana', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don\'t look even slightly believable.'),
(6, 1, NULL, 'key da silva', 'key@hotmail.com', '$2y$10$eSsilhtRDlMaN7PPNyrPK.r.Cq66vmB5yYHLtgG1.HmJvE9IEXBeq', '22011-011', 'Rio de Janeiro', 'Copacabana', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.'),
